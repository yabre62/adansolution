    ...
    <div class="container">
        <div class="row">
            ...
            <div class="sidebar_heading col-md-9">
                <h1 class="h3  mb-0 folot-left headerTitle"><?php echo e(trans('messages.chat_with_seller')); ?></h1>
            </div>
        </div>
    </div>
            ...
            <div class="card box-shadow-sm"> 
                <div class="inbox_people">
                    ...
                    <?php if(isset($unique_shops)): ?>
                        ...
                        <div class="chat_list <?php if($key == 0): ?> btn-primary <?php endif; ?>" id="user_<?php echo e($shop->shop_id); ?>">
                            <div class="chat_people" id="chat_people">
                            <div class="chat_img"> 
                                <img src="<?php if($shop->image == 'def.png'): ?><?php echo e(asset(''.$shop->image)); ?> <?php else: ?> <?php echo e(asset('shop/'.$shop->image)); ?> <?php endif; ?>" style="border-radius: 10px">
                            </div>
                            <div class="chat_ib">
                                <h5 class="seller <?php if($shop->seen_by_customer): ?>active-text <?php endif; ?>" id="<?php echo e($shop->shop_id); ?>"><?php echo e($shop->name); ?></h5>
                            </div>
                            </div>
                        </div>
                ...
                <div class="inbox_msg">
                    ...
                    <div class="msg_history" id="show_msg">
                        ...
                        <?php $__currentLoopData = $chattings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="incoming_msg">
                                <div class="incoming_msg_img"> <img src="<?php if($chat->image == 'def.png'): ?><?php echo e(asset(''.$chat->image)); ?> <?php else: ?> <?php echo e(asset('shop/'.$chat->image)); ?> <?php endif; ?>" alt="sunil"> </div>
                            ...
                            <div class="outgoing_msg">
                                ...
                                <span class="time_date"> <?php echo e($chat->created_at->format('h:i A')); ?>    |    <?php echo e($chat->created_at->format('M d')); ?> </span> </div>
                            </div>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="type_msg">
                        ...
                        <form class="form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-2" id="myForm" >
                            ...
                            <input type="text" id="hidden_value" hidden value="<?php echo e($last_chat->shop_id); ?>" name="">
                            <input type="text" id="seller_value" hidden value="<?php echo e($last_chat->shop->seller_id); ?>" name="">
              ...
              if (data.length != 0) {
                data.map((element, index) => {
                  ...
                  if (element.sent_by_customer) {
                    ...
                    let img_path = element.image == 'def.png' ? `${window.location.origin}/${element.image}` : `${window.location.origin}/shop/${element.image}`;
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/web-views/users-profile/profile/chat-with-seller.blade.php ENDPATH**/ ?>