            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="<?php echo e(route('admin.dashboard.index')); ?>" aria-label="">
                    ...
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                         onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                         src="<?php echo e(asset("company/$e_commerce_logo")); ?>"
                         alt="Logo">
                ...
                <div class="d-none d-md-block">
                    <form class="position-relative">
                      ...
                      <div class="input-group input-group-merge input-group-borderless input-group-hover-light navbar-input-group">
                        ...
                        <input type="search" class="js-form-search form-control" id="search-bar-input" placeholder="<?php echo e(trans('messages.search')); ?>" aria-label="Search in front" data-hs-form-search-options="{
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('admin')); ?>/<?php echo e(auth('admin')->user()->image); ?>"
...
<?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/layouts/back-end/partials/_header.blade.php ENDPATH**/ ?>