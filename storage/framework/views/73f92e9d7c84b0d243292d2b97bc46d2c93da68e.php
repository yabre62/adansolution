                ...
                <div class="card">
                    ...
                    <span class="font-name">
                        <a href="<?php echo e(route('product',$product['slug'])); ?>"><?php echo e($product['name']); ?></a>
                            ...
                            <br>
                            <span class="sellerName"> <?php echo e(trans('messages.Brand')); ?> :<?php echo e($product->brand?$product->brand['name']:''); ?> </span>
...
<?php endif; ?>
<?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/web-views/partials/_wish-list-data.blade.php ENDPATH**/ ?>