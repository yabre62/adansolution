        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="<?php echo e(route('admin.product.list', 'in_house')); ?>"><?php echo e(trans('messages.Product')); ?></a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1" style="padding-top: 30px;margin-left: -20px;">
                                        <select
                                            ...
                                            name="discount_type">
                                            <option
                                                value="percent" <?php echo e($product['discount_type']=='percent'?'selected':''); ?>><?php echo e(trans('messages.Percent')); ?></option>
                                            <option
                                                value="flat" <?php echo e($product['discount_type']=='flat'?'selected':''); ?>><?php echo e(trans('messages.Flat')); ?></option>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/admin-views/product/edit.blade.php ENDPATH**/ ?>