                                ...
                                <?php $__currentLoopData = $chattings_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chatting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="chat_list <?php if($key == 0): ?> active <?php endif; ?>"
                                        ...
                                        <div class="chat_people" id="chat_people">
                                            <div class="chat_img">
                                                <img src="<?php echo e(asset('profile/'.$chatting->image)); ?>"
                                                ...
                                                <div class="incoming_msg">
                                                    <div class="incoming_msg_img">
                                                        <img style="width: 30px;height: 30px;border-radius: 50%"
                                                            src="<?php echo e(asset('profile/'.$message->image)); ?>"
                                                            onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                                            alt="">
                                                    </div>
                ...
                $.ajax({
                  ...
                  <div class="incoming_msg" id="incoming_msg">
                    <div class="incoming_msg_img" id="">
                      <img src="${window.location.origin}/profile/${element.image}" style="border-radius: 10px;" alt="">
                    </div>
                    <div class="received_msg">
                      <div class="received_withd_msg">
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/seller-views/chatting/chat.blade.php ENDPATH**/ ?>