                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="input-group-overlay d-md-none my-3">
                        <form action="<?php echo e(route('products')); ?>" type="submit" class="search_form">
                            ...
                            <input name="page" value="1" hidden>
                            <button class="input-group-append-overlay search_button" type="submit"
                                    style="border-radius: 0px 7px 7px 0px; color:white;">
                            <span class="input-group-text" style="font-size: 20px;">
                                <i class="czi-search text-white"></i>
                            </span>
                            </button>
...
<?php /**PATH C:\xampp\htdocs\adanSolutionAdmin\resources\views/layouts/front-end/partials/_header.blade.php ENDPATH**/ ?>
