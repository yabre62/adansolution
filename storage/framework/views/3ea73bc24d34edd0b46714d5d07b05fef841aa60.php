    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('seller.product.list')); ?>">Product</a></li>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" min="0" value="0" step="0.01"
                                               placeholder="<?php echo e(trans('messages.Discount')); ?>" name="discount" value="<?php echo e(old('discount')); ?>"
                                               class="form-control">
                                    </div>
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/seller-views/product/add-new.blade.php ENDPATH**/ ?>