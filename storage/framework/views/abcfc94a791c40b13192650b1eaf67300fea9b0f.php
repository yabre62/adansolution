    ...
    <div class="content container-fluid">
                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title"><?php echo e(trans('messages.Order')); ?> <?php echo e(trans('messages.Report')); ?>  <?php echo e(trans('messages.Overview')); ?></h1>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1"><?php echo e(trans('messages.Delivered')); ?></h4>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1"><?php echo e(trans('messages.Returned')); ?></h4>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1"><?php echo e(trans('messages.Failed')); ?></h4>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1"><?php echo e(trans('messages.Processing')); ?></h4>
        ...
        <div class="card mb-3 mb-lg-5 border-bottom border-right border-left border-top">
            ...
            <div class="card-header">
                ...
                ?>
                <h6 class="card-subtitle mb-0">Total orders of <?php echo e(date('Y')); ?>: <span
        ...
        <div class="row">
            <div class="col-lg-12 mb-3 mb-lg-12">
                ...
                <div class="card h-100">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title"><?php echo e(trans('messages.Weekly')); ?> <?php echo e(trans('messages.Report')); ?> </h4>
                        ...
                        <ul class="nav nav-segment" id="eventsTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="this-week-tab" data-toggle="tab" href="#this-week"
                                   role="tab">
                                   <?php echo e(trans('messages.This')); ?> <?php echo e(trans('messages.week')); ?>

                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="last-week-tab" data-toggle="tab" href="#last-week" role="tab">
                                    <?php echo e(trans('messages.Last')); ?> <?php echo e(trans('messages.week')); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#<?php echo e($order['id']); ?> <small
                                                            class="font-size-sm text-body text-uppercase"><?php echo e(trans('messages.Orders')); ?> <?php echo e(trans('messages.ID')); ?></small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0"><?php echo e(trans('messages.Order')); ?> <?php echo e(trans('messages.Amount')); ?>
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        <?php echo e(trans('messages.Orders')); ?>  <?php echo e(trans('messages.Status')); ?> <strong> : <?php echo e(Illuminate\Support\Str::ucfirst($order['order_status'])); ?> <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
                                       ...
                                       href="<?php echo e(route('admin.orders.details',['id'=>$order['id']])); ?>">
                                        <div class="card-body py-0">
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#<?php echo e($order['id']); ?> <small
                                                            class="font-size-sm text-body text-uppercase"><?php echo e(trans('messages.ID')); ?></small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0"><?php echo e(trans('messages.Order')); ?> <?php echo e(trans('messages.Amount')); ?>
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        <?php echo e(trans('messages.Status')); ?> <strong> : <?php echo e(Illuminate\Support\Str::ucfirst($order['order_status'])); ?> <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/admin-views/report/order-index.blade.php ENDPATH**/ ?>