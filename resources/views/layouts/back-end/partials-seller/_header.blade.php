            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('seller.dashboard.index')}}" aria-label="">
                    <img class="navbar-brand-logo" style="max-height: 42px;"
                         onerror="this.src='{{asset('public/assets/back-end/img/logo.png')}}'"
                         src="{{asset("shop/$seller_logo")}}" alt="Logo" height="40" width="40">
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                         onerror="this.src='{{asset('public/assets/back-end/img/160x160/img1.jpg')}}'"
                         src="{{asset("shop/$seller_logo")}}"
                            ...
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    {{-- <img src="{{asset('seller/'.auth('seller')->user()->image)}}"  onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" class="img-profile rounded-circle"> --}}
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('public/assets/back-end/img/160x160/img1.jpg')}}'"
                                         src="{{asset('seller/')}}/{{auth('seller')->user()->image}}"
