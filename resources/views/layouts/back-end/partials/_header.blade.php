            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard.index')}}" aria-label="">
                    <img class="navbar-brand-logo" style="max-height: 42px;"
                         ...
                         src="{{asset("company/$e_commerce_logo")}}"alt="Logo">
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                         src="{{asset("company/$e_commerce_logo")}}"
                         alt="Logo">
                ...
                <div class="d-none d-md-block">
                    <form class="position-relative">
                      ...
                      <div class="input-group input-group-merge input-group-borderless input-group-hover-light navbar-input-group">
                        ...
                        <input type="search" class="js-form-search form-control" id="search-bar-input" placeholder="{{ trans('messages.search') }}" aria-label="Search in front" data-hs-form-search-options="{
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('admin')}}/{{auth('admin')->user()->image}}"
