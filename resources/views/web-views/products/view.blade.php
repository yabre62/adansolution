...
@push('css_or_js')
    <meta property="og:image" content="{{asset('company')}}/{{$web_config['web_logo']}}"/>
    <meta property="og:title" content="Products of {{$web_config['name']}} "/>
    <meta property="og:url" content="{{env('APP_URL')}}">
    <meta property="og:description" content="{!! substr($web_config['about']->value,0,100) !!}">

    <meta property="twitter:card" content="{{asset('company')}}/{{$web_config['web_logo']}}"/>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h1 class="h3 text-dark mb-3 headerTitle text-uppercase">
                            ...
                            <label>( {{$products->total()}} {{trans('messages.result_found')}} )</label>
                        </h1>
                    </div>
            ...
            <section class="col-lg-9">
                ...
                @else
                    <div class="text-center pt-5">
                        <h2>{{trans('messages.result_not_found')}}</h2>
                    </div>
                @endif
            </section>
        </div>
