...
@push('css_or_js')
    ...
    @if($product['meta_image']!=null)
        <meta property="og:image" content="{{asset("product/meta")}}/{{$product->meta_image}}"/>
        <meta property="twitter:card"
              content="{{asset("product/meta")}}/{{$product->meta_image}}"/>
    @else
        <meta property="og:image" content="{{asset("product/thumbnail")}}/{{$product->thumbnail}}"/>
        <meta property="twitter:card"
              content="{{asset("product/thumbnail/")}}/{{$product->thumbnail}}"/>
    @endif
        ...
        <div class="row ">
            ...
            <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-3">
                <div class="details">
                    ...
                    @if($product->discount > 0)
                        <div class="mb-3">
                            <strong>{{trans('messages.reduction')}} : </strong>
                    ...
                    <!-- Quantity + Add to cart -->
                        <div class="row no-gutters">
                            <div class="col-2">
                                <div class="product-description-label mt-2">{{ trans('messages.Quantity') }}:</div>
                            </div>
                            <div class="col-10">
                        ...
                        <div class="row no-gutters d-none mt-2" id="chosen_price_div">
                            <div class="col-5">
                                <div class="product-description-label">{{ trans('messages.priceT') }}:</div>
                            </div>
                            <div class="col-7">
                        ...
                        <div class="shop_image d-flex justify-content-center align-items-center">
                            <a href="#" class="d-flex justify-content-center">
                                <img style="height: 65px; width: 65px; border-radius: 50%"
                                     src="{{asset('shop')}}/{{$product->seller->shop->image}}"
                    ...
                    <div class="seller_shop">
                        <div class="shop_image d-flex justify-content-center align-items-center">
                            <a href="{{ route('shopView',[0]) }}" class="d-flex justify-content-center">
                                <img style="height: 65px;width: 65px; border-radius: 50%"
                                     src="{{asset("company")}}/{{$web_config['fav_icon']->value}}"
                                     onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                     alt="">
                            </a>
                        </div>
                                                      ...
                                                      <div class="d-flex mb-3 pr-5">
                                                          <div class="media media-ie-fix align-items-center mr-4 pr-2">
                                                              <img style="max-height: 64px;" class="rounded-circle" width="64"
                                                                   onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                                   src="{{asset("profile/".$productReview->user->image)}}"
                                                          ...
                                                          @if (!empty(json_decode($productReview->attachment)))
                                                              @foreach (json_decode($productReview->attachment) as $key => $photo)
                                                                  <img
                                                                      ...
                                                                      onclick="showInstaImage('{{asset("$photo")}}')"
                                                                      class="cz-image-zoom"
                                                                      onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                                      src="{{asset("$photo")}}"
