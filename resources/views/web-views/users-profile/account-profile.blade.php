                        ...
                        <form class="mt-3" action="{{route('user-update')}}" method="post"
                            ...
                            <div class="row photoHeader">
                                ...
                                <img id="blah"
                                     ...
                                     src="{{asset('profile')}}/{{$customerDetail['image']}}">
                    ...
                    <form action="{{route('user-update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="bg-secondary rounded-lg p-4 mb-4">
                            <div class="media align-items-center">
                                <img id="blah" style="width: 80px; height: 80px;" src="{{asset('profile')}}/{{$customerDetail['image']}}" width="90" alt="{{$customerDetail['f_name']}}">
