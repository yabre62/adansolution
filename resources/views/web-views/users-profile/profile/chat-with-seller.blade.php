                ...
                <div class="inbox_people">
                    ...
                    @if (isset($unique_shops))
                        ...
                        <div class="chat_list @if ($key == 0) btn-primary @endif" id="user_{{$shop->shop_id}}">
                            ...
                            <div class="chat_img"> 
                                <img src="@if($shop->image == 'def.png'){{asset(''.$shop->image)}} @else {{asset('shop/'.$shop->image)}} @endif" style="border-radius: 10px">
                            </div>
                            <div class="chat_ib">
                    ...
                    <div class="msg_history" id="show_msg">
                        ...
                        @foreach($chattings as $key => $chat)
                            ...
                            <div class="incoming_msg">
                                <div class="incoming_msg_img"> <img src="@if($chat->image == 'def.png'){{asset(''.$chat->image)}} @else {{asset('shop/'.$chat->image)}} @endif" alt="sunil"> </div>
