...
<aside class="col-lg-4 pt-4 pt-lg-0">
    <div class="cart_total">
        ...
        @endif
        <div class="d-flex justify-content-between">
            <span class="cart_title">{{ trans('messages.sub_total') }}</span>
        ...
        <div class="d-flex justify-content-between">
            <span class="cart_title">{{trans('messages.Shipping')}}</span>
            <span class="cart_value">
        ...
        @else
            <div class="mt-2">
                <form class="needs-validation" method="post" novalidate id="coupon-code-ajax">
                    ...
                    <button class="btn btn-primary btn-block" type="button" onclick="couponCode()">{{trans('messages.apply_code')}}
                    </button>
                </form>
            </div>
            @php($coupon_dis=0)
