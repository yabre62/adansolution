                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">{{trans('messages.name')}} {{trans('messages.Full')}}   <i
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('admin-profile-form','Want to update admin info ?')":"call_demo()"}}" class="btn btn-primary">Enregistrer</button>
                            </div>
                            <!-- End Form -->
                        </div>
                        <!-- End Body -->
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="js-pwstrength form-control" name="password"
                                           id="newPassword" placeholder="{{ trans('messages.new_password') }}"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm','Voulez vous vraiment mettre à jour ?')":"call_demo()"}}" class="btn btn-primary">{{trans('messages.Save')}} {{trans('messages.changes')}}</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
