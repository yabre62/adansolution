            ...
            <div class="row">
                <div class="col-12 " style="padding:15px;" header>
                    <div style="float: left;padding: 15px">
                        <img height="70" width="200" src="{{asset("company/$company_web_logo")}}"
                             alt="">
...
<div style="padding:0 1.5rem; display:block; height:auto !important;">
    <table style="width: 46%;margin-left:auto;  " class="text-right sm-padding  strong">
        ...
        <tr>
            <th class="gry-color text-left strong bold">{{ trans('messages.sub_total') }}</th>
        ...
        <tr>
            <th class="gry-color text-left strong bold">{{trans('messages.Shipping')}}</th>
        ...
        <tr class="border-bottom">
            <th class="gry-color text-left strong bold">{{trans('messages.discount') }}</th>
