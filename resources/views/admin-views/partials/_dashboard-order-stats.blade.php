<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['pending'])}}" style="background: #ff7600; box-shadow: 0 1rem 1rem #ffa50a">
        <div class="card-body">
            <h6 class="card-subtitle"
                style="color: white!important;">{{__('messages.pending')}}</h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['confirmed'])}}" style="background: #069d0b; box-shadow: 0 1rem 1rem #15a920">
        <div class="card-body">
            <h6 class="card-subtitle"
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['processing'])}}" style="background: #053742">
        <div class="card-body">
            <h6 class="card-subtitle"
                style="color: white!important;">{{__('messages.Processing')}}</h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['out_for_delivery'])}}" style="background: #343A40">
        <div class="card-body">
            <h6 class="card-subtitle"
                style="color: white!important;">{{__('messages.out_for_delivery')}}</h6>
