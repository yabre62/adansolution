                    ...
                    <div class="card-body" style="padding: 20px">
                        <center>
                            <img height="200" style="width: 100%" id="viewerML"
                                 ...
                                 src="{{asset('shop')}}/{{\App\CPU\Helpers::get_business_settings('shop_banner')}}">
                        </center>
                        <hr>
                    ...
                    <div class="card-body" style="padding: 20px">
                        <center>
                            <img width="200" id="viewerWL"
                                 onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                 src="{{asset('company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0]}}">
                        </center>
                        <hr>
                    ...
                    <div class="card-body" style="padding: 20px">
                        <center>
                            <img width="200" id="viewerML"
                                 onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                 src="{{asset('company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0]}}">
                        </center>
                        <hr>
                    ...
                    <div class="card-body" style="padding: 20px">
                        <center>
                            <img width="200" id="viewerWFL"
                                 onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                 src="{{asset('company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0]}}">
                        </center>
                        <hr>
                    ...
                    <div class="card-body" style="padding: 20px">
                        <center>
                            <img width="60" id="viewerFI"
                                 onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                 src="{{asset('company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0]}}">
                        </center>
                        <hr>
