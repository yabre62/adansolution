                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type_of_shop" disabled value="{{$shop->type_of_shop}}" class="form-control" id="name"
                                            required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <center>
                                    ...
                                    src="{{asset('shop/'.$shop->image)}}" alt="Product thumbnail"/>
                                </center>
                            </div>
                            <div class="col-md-6 mb-4 mt-2">
                                ...
                                <center>
                                    <img style="width: auto; height:auto; border: 1px solid; border-radius: 10px; max-height:200px" id="viewerBanner"
                                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('shop/banner/'.$shop->banner)}}" alt="Product thumbnail"/>
                                </center>
                            </div>
                        </div>
